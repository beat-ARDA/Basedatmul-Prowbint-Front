        ...
        <div className='container-fluid d-flex justify-content-center align-items-center'>
            <form className='w-50 padre-registro'>
                ...
                <div className='row m-0 pb-1'>
                    ...
                    <div id="reglas-nombres" className="form-text">
                ...
                <div className='row m-0 pb-1'>
                    ...
                    <div id="reglas-apellidos" className="form-text">
                        Este campo es (Obligatorio)
                    </div>
                </div>
                <div className='row m-0 pb-1'>
                ...
                <div className='row m-0 pb-1'>
                    ...
                    <div id="reglas-contraseña" className="form-text">
                        8 caracteres al menos, una mayuscula, un caracter especial y un numero al menos.
                    </div>
                </div>
                <div className='row m-0 pb-1'>
                    <div className='col-12 m-0 p-0 d-flex justify-content-center align-items-center'>
                        <select defaultValue={"none"} aria-describedby="reglas-tipo-usuario" className="form-select text-secondary" aria-label="Tipo de usuario" name="tipo-usuario">
                ...
                <div className='row m-0 pb-1'>
                    <div className='col-12 m-0 p-0 d-flex justify-content-center align-items-center'>
                        <select defaultValue={"none"} aria-describedby="reglas-genero" className="form-select text-secondary" aria-label="Tipo de usuario" name="tipo-usuario">
