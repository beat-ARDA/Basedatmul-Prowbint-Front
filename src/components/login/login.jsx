        ...
        <form className="d-flex flex-column w-100 h-75 align-items-center justify-content-center" action="#">
            ...
            <div className="row w-100 p-0 m-0 d-flex flex-column align-items-center justify-content-center">
                <div className="col-xl-4 col-9">
                    <input name="correo" type="text" className="mb-1 login-input w-100" placeholder="Correo..." />
                </div>
                <div className="col-xl-4 col-9">
                    <input name="contraseña" type="password" className="mb-1 login-input w-100" placeholder="Contraseña..." />
                </div>
                <div className="col-xl-4 col-9">
                    <button type="submit" className="mb-1 ingresar-button w-100">Ingresar</button>
                </div>
            </div>
