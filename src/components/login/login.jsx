...
function Login() {
    return (
        <form className="d-flex flex-column w-100 h-75 align-items-center justify-content-center" action="#">
            ...
            <input name="correo" type="text" className="mb-1 w-25 login-input" placeholder="Correo..."/>
            <input name="contraseña" type="password" className="mb-1 w-25 login-input" placeholder="Contraseña..."/>
            <button type="submit" className="mb-1 w-25 ingresar-button">Ingresar</button>
