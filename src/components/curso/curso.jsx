...
import { getCoursesActive, getCourseById, postCourseAlumn } from '../../servicesPw2/courses'
                    ...
                    <PayPalScriptProvider options={{ "client-id": process.env.REACT_APP_CLIENT_ID_PAYPAL }}>
                        <PayPalButtons
                            ...
                            onApprove={(data, actions) => {
                                ...
                                if (api == 'pw2') {
                                    postCourseAlumn(idCurso, formData).then((data) => {
                                        console.log(data);
                                    });
                                }
                                else {
                ...
                <div className='row p-0 m-0'>
                    <div className='col-12 p-0 m-0 d-flex justify-content-center'>
                        <iframe
                            width="100%"
                            height="500"
                            src={video ? `${'http://localhost:3000/'}${video}` : 'http://localhost:3000/uploads/video.mp4'}
                            title="Video curso"
                            frameBorder="0"
