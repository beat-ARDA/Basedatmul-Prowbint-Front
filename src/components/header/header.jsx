...
function Header() {
    return (
        <nav className="container-fluid d-flex" id="navbar-background">
            <div className="col-1 d-flex align-items-center justify-content-center">
                {/* <div id="navbar-logo"></div> */}
                <svg id="navbar-logo" version="1.0" xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-1 d-flex align-items-center justify-content-start">
                <a href="./" className="titulo-navbar">Categorias</a>
            </div>
            <div className="col-7 d-flex align-items-center">
                <form id="form-navbar" className="w-100 d-flex">
                    <div className="col-1">
                    ...
                    <div className="col-11 d-flex align-items-center justify-content-start w-80">
                        <input id="search-area" className="w-100" type="text" name="search-area" placeholder="Buscar cualquier cosa" />
                    </div>
                </form>
            </div>
            <div className="col-1 d-flex align-items-center justify-content-center">
