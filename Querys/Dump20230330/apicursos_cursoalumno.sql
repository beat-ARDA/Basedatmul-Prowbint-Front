...
CREATE TABLE `cursoalumno` (
  ...
  `curso` int NOT NULL,
  `alumno` int NOT NULL,
  `compro_completo` tinyint(1) NOT NULL,
  `termino_curso` tinyint(1) NOT NULL,
  ...
  KEY `curso` (`curso`),
  KEY `alumno` (`alumno`),
  CONSTRAINT `cursoalumno_ibfk_1` FOREIGN KEY (`curso`) REFERENCES `cursos` (`idCurso`),
  CONSTRAINT `cursoalumno_ibfk_2` FOREIGN KEY (`alumno`) REFERENCES `users` (`userId`)
